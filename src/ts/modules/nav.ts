const navOpenButtonElement: HTMLButtonElement = document.querySelector('.nav__menu-button')
const navCloseButtonElement: HTMLButtonElement = document.querySelector('.nav__modules--header')
